...
func integrate(
	...
	if airspeed >= MIN_AIRSPEED:
		...
		var lift_force_magnitude := dynamic_force * get_lift_coefficient(flyer_state.actual_aoa)
		var high_aoa_drag_force := dynamic_force * get_high_aoa_drag_coefficient(flyer_state.actual_aoa)
